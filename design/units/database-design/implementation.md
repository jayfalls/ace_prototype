...
|----|--------|-----------|----------|-------|
| 0 | `feature/docs-gen-tooling` | `scripts/`, Makefile | — | 0 |
| 1 | `feature/docs-conventions` | `conventions.md` | FR-3.1, FR-3.2 | 1 |
| 2 | `feature/docs-schema` | `schema/{entity}/` | FR-1.1 | 1 |
| 3 | `feature/docs-openapi` | `openapi.yaml` | FR-2.1 | 1 |
| 4 | `feature/docs-erd` | `erd/` (7 files) | FR-1.2 | 2 |
| 5 | `feature/docs-indexes` | `indexes.md` | FR-1.3 | 2 |
| 6 | `feature/docs-query-patterns` | `query-patterns/` (5 files) | FR-1.4 | 2 |
| 7 | `feature/docs-sqlc` | `sqlc.md` | FR-2.3 | 2 |
| 8 | `feature/docs-connection-pooling` | `connection-pooling.md` | FR-3.3 | 2 |
| 9 | `feature/docs-transactions` | `transactions.md` | FR-3.4 | 2 |
| 10 | `feature/docs-query-helpers` | `query-helpers.md` | FR-3.5 | 2 |
| 11 | `feature/docs-migrations` | `migrations.md` | FR-4.1–4.4 | 2 |
| 12 | `feature/docs-endpoint-map` | `endpoint-map.md` | FR-2.2 | 3 |
| 13 | `feature/docs-errors` | `errors.md` | FR-2.4 | 3 |
| 14 | `feature/docs-legacy-patterns` | `legacy-patterns.md` | FR-5.1 | 3 |
| 15 | `feature/docs-agent-api-ref` | `agents/api-reference.md` | FR-6.1 | 3 |
| 16 | `feature/docs-agent-schema-gen` | `agents/schema-generation.md` | FR-6.2 | 3 |
| 17 | `feature/docs-agent-patterns` | `agents/patterns.md` | FR-6.3 | 3 |
| 18 | `feature/docs-migration-plan` | `migration-plan.md` | FR-5.2, FR-5.3 | 4 |
| 19 | `feature/docs-compatibility` | `compatibility.md` | FR-5.4 | 4 |
| 20 | `feature/docs-agent-training` | `agents/training/` (4 files) | FR-6.4 | 5 |
| 21 | `feature/docs-agent-config` | `agents/config-updates.md` | FR-6.5 | 5 |
| 22 | `feature/docs-agent-tests` | `tests/agent-integration/` | FR-6.5 | 5 |
