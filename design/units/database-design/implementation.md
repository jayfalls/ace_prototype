...
|------|-------------|--------|--------------|
| 0.1 | Create `scripts/docs-gen/main.go` — entry point that orchestrates all doc generation | 2h | None |
| 0.2 | Create `scripts/schema-doc-gen/main.go` — extracts schema from `pg_catalog`, outputs markdown | 4h | None |
| 0.3 | Create `scripts/erd-gen/main.go` — generates Mermaid ERD from FK metadata | 2h | 0.2 |
| 0.4 | Create `scripts/openapi-gen/` — runs Annot8 to generate `openapi.yaml` | 2h | None |
| 0.5 | Create `scripts/validate-docs/main.go` — compares live schema vs docs, fails on drift | 3h | 0.2 |
| 0.6 | Add `docs` target to Makefile — wraps `go run ./scripts/docs-gen/` | 30m | 0.1 |

**Note**: Task 0.2 (4h) is for a production-quality `pg_catalog` extraction script with proper error handling, connection management, and output formatting. This is the most complex script in the tooling.

### PR-0: Tooling Foundation
...
## Phase 1: Foundation Documents (Batch 1)
...
### PR-2: Schema Documentation (per-entity)
...
### PR-3: OpenAPI Specification (initial)
...
## Phase 2: Derived Documents (Batch 2)

These documents depend on Phase 1 foundations. They can be produced in parallel once Phase 1 is complete.
...
## Phase 3: Cross-Reference Documents (Batch 3)

These documents synthesize information from Phase 1 and Phase 2 artifacts.

### PR-12: Endpoint-to-DB Mapping
...
### PR-16: Agent Schema Generation Guide
...
## Phase 4: Derivative Documents (Batch 4)

These depend on Phase 3 outputs and must be sequential.

### PR-18: Migration Plan
...
- Depends on legacy-patterns.md (PR-14) and conventions.md (PR-1)

---

### PR-19: Backward Compatibility
...
- Depends on migration-plan.md (PR-18)

---

## Phase 5: Agent Training & Integration (Batch 5)

Final phase — depends on all previous phases.

### PR-20: Agent Training Materials
...
- [ ] **Phase 0: Tooling**
  - [ ] PR-0: `scripts/docs-gen/`, `scripts/schema-doc-gen/`, `scripts/erd-gen/`, `scripts/openapi-gen/`, `scripts/validate-docs/`, Makefile `docs` target

- [ ] **Phase 1: Foundations**
  - [ ] PR-1: `conventions.md`
  - [ ] PR-2: `schema/{entity}/` (per-table docs)
  - [ ] PR-3: `openapi.yaml`

- [ ] **Phase 2: Derived**
  - [ ] PR-4: `erd/` (6 entity groups + master)
  - [ ] PR-5: `indexes.md`
  - [ ] PR-6: `query-patterns/` (5 categories)
  - [ ] PR-7: `sqlc.md`
  - [ ] PR-8: `connection-pooling.md`
  - [ ] PR-9: `transactions.md`
  - [ ] PR-10: `query-helpers.md`
  - [ ] PR-11: `migrations.md`

- [ ] **Phase 3: Cross-Reference**
  - [ ] PR-12: `endpoint-map.md`
  - [ ] PR-13: `errors.md`
  - [ ] PR-14: `legacy-patterns.md`
  - [ ] PR-15: `agents/api-reference.md`
  - [ ] PR-16: `agents/schema-generation.md`
  - [ ] PR-17: `agents/patterns.md`

- [ ] **Phase 4: Derivative**
  - [ ] PR-18: `migration-plan.md`
  - [ ] PR-19: `compatibility.md`

- [ ] **Phase 5: Agent Integration**
  - [ ] PR-20: `agents/training/` (4 scenario files)
  - [ ] PR-21: `agents/config-updates.md`
  - [ ] PR-22: `tests/agent-integration/`

---

## PR Summary Table

| PR | Branch | Artifacts | FSD Reqs | Effort | Phase |
|----|--------|-----------|----------|--------|-------|
| 0 | `feature/docs-gen-tooling` | `scripts/`, Makefile | — | 13.5h | 0 |
| 1 | `feature/docs-conventions` | `conventions.md` | FR-3.1, FR-3.2 | 2h | 1 |
| 2 | `feature/docs-schema` | `schema/{entity}/` | FR-1.1 | 4h | 1 |
| 3 | `feature/docs-openapi` | `openapi.yaml` | FR-2.1 | 3h | 1 |
| 4 | `feature/docs-erd` | `erd/` (7 files) | FR-1.2 | 3h | 2 |
| 5 | `feature/docs-indexes` | `indexes.md` | FR-1.3 | 1.5h | 2 |
| 6 | `feature/docs-query-patterns` | `query-patterns/` (5 files) | FR-1.4 | 3h | 2 |
| 7 | `feature/docs-sqlc` | `sqlc.md` | FR-2.3 | 1.5h | 2 |
| 8 | `feature/docs-connection-pooling` | `connection-pooling.md` | FR-3.3 | 1h | 2 |
| 9 | `feature/docs-transactions` | `transactions.md` | FR-3.4 | 1h | 2 |
| 10 | `feature/docs-query-helpers` | `query-helpers.md` | FR-3.5 | 1h | 2 |
| 11 | `feature/docs-migrations` | `migrations.md` | FR-4.1–4.4 | 3h | 2 |
| 12 | `feature/docs-endpoint-map` | `endpoint-map.md` | FR-2.2 | 2h | 3 |
| 13 | `feature/docs-errors` | `errors.md` | FR-2.4 | 1.5h | 3 |
| 14 | `feature/docs-legacy-patterns` | `legacy-patterns.md` | FR-5.1 | 1.5h | 3 |
| 15 | `feature/docs-agent-api-ref` | `agents/api-reference.md` | FR-6.1 | 2h | 3 |
| 16 | `feature/docs-agent-schema-gen` | `agents/schema-generation.md` | FR-6.2 | 2h | 3 |
| 17 | `feature/docs-agent-patterns` | `agents/patterns.md` | FR-6.3 | 1.5h | 3 |
| 18 | `feature/docs-migration-plan` | `migration-plan.md` | FR-5.2, FR-5.3 | 2h | 4 |
| 19 | `feature/docs-compatibility` | `compatibility.md` | FR-5.4 | 1.5h | 4 |
| 20 | `feature/docs-agent-training` | `agents/training/` (4 files) | FR-6.4 | 3h | 5 |
| 21 | `feature/docs-agent-config` | `agents/config-updates.md` | FR-6.5 | 1h | 5 |
| 22 | `feature/docs-agent-tests` | `tests/agent-integration/` | FR-6.5 | 2h | 5 |

**Total estimated effort**: ~58.5h across 23 PRs
