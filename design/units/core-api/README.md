...
Establish API & DB patterns, structure, tools, and libraries.
...
- Testing - Testing strategy (TBD)
- Dependencies - External dependencies (TBD)
...
This unit focuses on foundational patterns, NOT implementing any features.
